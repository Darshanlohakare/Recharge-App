...
<body>
	...
	<table class="table table-success table-striped-columns">
		...
		List<Recharge> lst=rdao.Recharge();
		for(Recharge r:lst)
		{
		%>
			<tr>
				...
				<td><%=r.planName %></td>
				<td><%=r.planDetails %></td>
				<td><a href="Payment.jsp" class="btn btn-primary"><%=r.planPrice %></a></td>
			</tr>
			<%} %>
	...
	<div class="d-grid gap-2 col-6 mx-auto">
  		<a href="UserDashboard.jsp" class="btn btn-primary">User Page</a>
	</div>
